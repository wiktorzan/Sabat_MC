...
NeutronHPphysics::NeutronHPphysics(const G4String& name) : G4VPhysicsConstructor(name), fThermal(true), fNeutronMessenger(0)
{
...
void NeutronHPphysics::ConstructProcess()
{
  ...
  //
  G4HadronInelasticProcess* process2 = new G4HadronInelasticProcess("NeutronInelastic", G4Neutron::Neutron());
